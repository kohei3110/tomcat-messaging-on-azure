...
<html:html xhtml="true" lang="true">
    <head>
        ...
        <title>ServiceBusResults Example</title>
        <html:base/>
        <link rel="stylesheet" type="text/css" href="../../css/example.css" />
    </head>
    <body>
        <html:link page="/jsp/servicebus/source.jsp">
        ...
        <h1>Service Bus Results</h1>
        <hr noshade="noshade"/>
        <p>Hello <bean:write name="serviceBusForm" property="name" />,</p>
    </body>
</html:html>